...
restaurant.register_user("Bhoomika Hiremath", "0123456789", "myavaneesh@gmail.com", "123 Main St, NewTown, Indai", "password007")

user = restaurant.login_user("myavaneesh@gmail.com", "password007")
...
restaurant.update_profile(user, "Bhoomika Hiremath", "9876543210", "myavaneesh@gmail.com", "010 Park St, DownTown, India", "passwordx7x")
